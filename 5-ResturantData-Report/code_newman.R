...
sf_merge = merge(sf_biz, sf_insp, by = "business_id")
sf_merged = merge(sf_merge, sf_violations, by = "business_id")
...
yolo_merged = merge(yolo_merge, yolo_violations, by = "business_id")
...
ala_merged = merge(ala_merge, ala_violations, by = "business_id")
